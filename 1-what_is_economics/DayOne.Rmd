...
+ Drop in office hours are Tues 2:30-3:30  through the last week of class. There is no need to make an appointment for these hours -- just come.
...
+ The class will use slack https://psuec202spring2019.slack.com
...
+ Key will be emailed to your @pdx.edu account.
+ Used to determine if you were in class that day.


## Why Is Taking Quiz Important?

+ Together they count the same as a midterm.
+ Students that miss more than 3 classes very rarely score more than 50% on the exams.
+ Miss 4 quizzes -- no problem.
+ Miss 5 or more and you get zeros on all following assignments and exams including the final.

## 

+ If you miss class five times -- drop the class to avoid an F on your transcript.
+ If you have an extended illness or other difficulty, file a deadline appeal to have the course removed from your record and get your tuition returned.  Note that deadline appeals require documentation.
+ Do not attempt to use the allowed absences strategically.
...
(From Last Term)[MT2Analysis.pdf]
...
+ What is the opportunity cost of not coming to class?
    ...
    + The first four are free, but after that it costs you an F.
...
+ Grade Arnold:  Does lack of abortion access make people act more 'responsibly'? 
+ Riju Joshi: How do you know cause rather than just correlation.
...
You have a marathon in June.  How do you train?
