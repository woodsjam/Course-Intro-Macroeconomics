...
\$1000 and an interest rate of 10\% grows to 10K in:
...
+ This is:
    ...
    + Yes, this is massive physical capital but a technological improvement on people with the finest cross cut saws in the world. https://www.youtube.com/watch?v=m0ZELXwFZkc
+ It is even:
    + Printed receipts
...
+ China with 7.13% per capital growth from 2010 - 2016
+ World with	1.53%
+ EU 	with 0.71%
+ US with 1.33%
