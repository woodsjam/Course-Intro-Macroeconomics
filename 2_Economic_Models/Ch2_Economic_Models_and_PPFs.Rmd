...
PPS: The set of call combinations of goods that can be produced with the available *resources* and existing *technology*.
...
"Efficient" has many meanings to economists.  In this case it means you can can only make more of one good by making less of other goods.
...
+ Physical Capital: Manufactured things use dot produce other things.  Often  these are the embodiment of technology changes.
...
The circular flow model gets at Principle #10, One person’s spending is another person’s income. 


Again, this a partial model.
...
+ We will spend a lot of time on that five sector model.
+ Many strange results that are actually true
      + Increases in the savings rate causes recessions. Japan is a nice example.
      + Government deficits cause trade deficits. US

+ IRL: Economists have more detailed models of each sector and their interaction and how the interact over time.
+ You will get the equivalent of a musical scale, just learning the notes, not playing a song.
